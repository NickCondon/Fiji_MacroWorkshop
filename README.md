...
In this repository is a PDF called Booklet.pdf which contains all the slides and exercises. There is also a file called CheatSheet.pdf which contains useful commands you will use frequently.

This workshop contains exercises to help test your knowledge. The slides contain the exercise description and any required files and answers are provided in the relevant folders.
