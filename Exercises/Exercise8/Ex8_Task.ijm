...
//###############																		//Defines input folder location with the variable path
...
// * * * * * * * Section 04 - Preparing Images for Analysis * * * * * * * * * * * * * *				
		...
		//###############																//Massaging nuclei channel before thresholding - MEAN Filter 4pixel radius
		...
		print("Number of Nuclei Found = "+//###############								//Reports number of found Nuclei into the Log window.

// * * * * * * * Section 05 - Getting measurements from the nuc Channel (CH2) * * * * * * * * * * * * * *				
...
// * * * * * * * Section 06 - Getting measurements from the Green Channel (CH1) * * * * * * * * * * * * * *				
			selectWindow("green");														//Selects the window with just Bio-sensor channel (green/ch1); see line 34
				//###############														//Ensures the Results table is clear
				//###############														//Selects the ROI corresponding with the loop number
				//###############														//Measures the ROI
				//###############														//Defines a variable for Bio-sensor Mean Intensity and collects the info from the results table
				//###############														//Defines a variable for Bio-sensor Maximum Intensity and collects the info from the results table
				imageNum = (z+1);														//Defines a variable for the current image number
		    	//###############														//Defines a variable for the current nuclei number
		    //###############															//Prints to summaryFile: filename, image#, #nuc, nuc#, nucArea, nucMeanInt, Ch1MeanInt, Ch1MaxInt
		  	}																			//Closing Analysis Loop for each nuclei

// * * * * * * * Section 07 - Saving & Closing Outputs * * * * * * * * * * * * * *				
		//###############																//Selecting the Mask window for Saving
